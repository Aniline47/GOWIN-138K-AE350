/*
 * ******************************************************************************************
 * File		: demo_slaveport.c
 * Author	: GowinSemicoductor
 * Chip		: AE350_SOC
 * Function	: Access ILM/DLM by slave port demo
 * ******************************************************************************************
 */
...
// If running access ILM/DLM by slave port demo
...
int demo_slaveport(void)
{
	...
	printf("\r\nMove %d data from ILM to DDR by slave port \r\n", data_size);
	memcpy(dst, src, data_size);
	...
	printf("\r\nMove %d data from DLM to DDR by slave port \r\n", data_size);
	memcpy(dst, src, data_size);
