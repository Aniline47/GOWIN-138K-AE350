...
// Aniline demo
#define RUN_GPIO_SPI			0	// Run gpio spi
#define RUN_DEMO_TFT			0	// Run tft demo
#define RUN_DEMO_DSP			0	// Run dsp demo
#define RUN_DEMO_RAM			0	// Run ram demo
...
#define RUN_DEMO_SLAVEPORT		0	// Run access ILM/DLM by slave port demo
#define RUN_DEMO_MM				0	// Run memory management demo
#define RUN_DEMO_INTR			0	// Run multiple peripherals interrupts demo

// Board feature demo
#define RUN_DEMO_DDR3			0	// Run read/write DDR3 demo
...
// Access ILM/DLM by slave port demo
